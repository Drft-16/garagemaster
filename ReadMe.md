...
-->Under first user name tag add another tag like <user username="tomcat" password="tomcat" roles="manager-gui,admin-gui,manager-script,manager-status" /> this.
-->Save the file
]
...
4. open apache tomcat ver 11 bin folder run server.